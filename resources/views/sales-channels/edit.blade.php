...
@section('title', 'تعديل قناة البيع - مصنع مفروشات سدير')
@section('page-title', 'تعديل قناة البيع: ' . $salesChannel->name_ar)
        ...
        <div class="border-bottom pb-3 mb-4 d-flex justify-content-between align-items-center">
            <div>
                <h5 class="fw-bold text-dark mb-1">
                    <i class="fas fa-edit text-warning me-2"></i> تعديل بيانات قناة البيع
                </h5>
                <p class="text-muted fs-7 mb-0">تحديث المسمى أو الترتيب أو حالة التفعيل.</p>
            </div>
            <code class="bg-light px-3 py-1.5 rounded-3 text-primary fs-6 fw-bold">{{ $salesChannel->code }}</code>
        </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('code', $salesChannel->code) }}" 
                           required>
                    @error('code')
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('sort_order', $salesChannel->sort_order) }}">
                    @error('sort_order')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('name_ar', $salesChannel->name_ar) }}" 
                           required>
                    @error('name_ar')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('name_en', $salesChannel->name_en) }}">
                    @error('name_en')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" 
                              id="description" 
                              rows="3" 
                              class="form-control @error('description') is-invalid @enderror">{{ old('description', $salesChannel->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-12 mt-2">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $salesChannel->is_active) ? 'checked' : '' }}>
                        <label class="form-check-label fw-semibold text-dark fs-7" for="is_active">
                            القناة نشطة ومتاحة للاستخدام
                        </label>
                    </div>
                </div>
